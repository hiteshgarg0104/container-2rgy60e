...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-2rgy60e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-2rgy60e.containers.anotherwebservice.com/
...
```
git clone git@github.com:hiteshgarg0104/container-2rgy60e.git
cd container-2rgy60e
```
...
```
docker attach container-2rgy60e
```
